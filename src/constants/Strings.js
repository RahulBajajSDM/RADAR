...
let Strings = {
  ...
  DisclaimerText: {
    conditions: [
      ...
      "✓ Also, for your reference you can use the following links(our source of information) when it comes to COVID-19 Risk Assessment.",
    ],
    linkUrl: ["https://www.who.int/", "http://cdc.gov/"],
  },
};
